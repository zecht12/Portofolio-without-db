...
export default function Page() {
  return (
    <div className='h-screen bg-primary/30'>
      <div className='container m-auto text-center xl:text-left flex items-center justify-center h-full'>
        <div className='flex flex-col w-full max-w-[900px] bg-pink-500/10 py-16 px-8'>
