...
export default function Home() {
  return (
    <div className='bg-primary/60 h-auto w-full'>
      <div className='w-full h-full bg-gradient-to-r from-primary/10 via-black/30 to-black/10'>
        <div className='flex flex-col justify-center text-center xl:pt-12 pt-28 xl:text-left container mx-auto'>
      ...
      <div className=' w-[1200px] h-auto absolute right-0 bottom-0 '>
