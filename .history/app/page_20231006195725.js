  ...
  return (
    <div className='bg-primary/60 h-full w-full'>
      ...
      <div className=' w-[1200px] h-full absolute right-0 bottom-0 '>
        ...
        <div>particle</div>
        <motion.div variants={fadeIn('down',0.5)} transition={{duration: 1,ease:}} initial="hidden" animate="show" exit="hidden" className='w-full h-full max-h-[678px] max-w-[737px] absolute -bottom-32 lg:bottom-0 lg:right-[8%] '>
          <Avatar/>
        </motion.div>
      </div>
    </div>
