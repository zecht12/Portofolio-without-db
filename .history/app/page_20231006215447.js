  ...
  return (
    <div className='bg-primary/60 h-auto w-full'>
      <div className='w-full h-auto bg-gradient-to-r from-primary/10 via-black/30 to-black/10'>
        <div className='flex flex-col justify-center text-center xl:pt-12 xl:text-left container mx-auto'>
          <motion.p variants={fadeIn('down',0.2)} initial="hidden" animate="show" exit="hidden" className='md:h1 h2'>
