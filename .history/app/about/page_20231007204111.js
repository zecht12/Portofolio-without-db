...
export default function Page() {
  ...
  return (
    <div className="h-a w-full bg-primary/30 py-32 text-center xl:text-left">
      <Circles/>
      ...
      <div className="container mx-auto h-full flex flex-col items-center xl:flex-row gap-x-6 px-4 xl:px-24">
        <div className="flex-1 flex flex-col justify-center xl:w-[650px]">
        ...
        <div className="flex flex-col w-full xl:max-w-[48%] md:h-[480px] ">
            ...
            {aboutData[index].info.map((item, itemIndex)=> {
              return(
                <div key={itemIndex} className="max-w-max gap-x-2 items-center text-white">
                  ...
                  <div className="grid grid-cols-5 md:grid-cols-10 gap-x-6 md:w-full ">
