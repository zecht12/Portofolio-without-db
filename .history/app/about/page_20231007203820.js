...
export default function Page() {
  ...
  return (
    <div className="h-full w-auto bg-primary/30 py-32 text-center xl:text-left">
      <Circles/>
      ...
      <div className="container mx-auto h-full w-full flex flex-col items-center xl:flex-row gap-x-6 px-0 xl:px-24">
        ...
        <div className="flex flex-col w-full xl:max-w-[48%] h-[480px] ">
            ...
            {aboutData.map((item, itemIndex) =>{
              return(
                <div
                  ...
                  className={`${index === itemIndex && 'text-accent after:w-full after:bg-accent after:transition-all after:duration-300 '}
          ...
          <div className="bg-pink-400/10 py-2 xl:py-6 flex flex-col gap-y-2 xl:gap-y-4 items-center xl:items-start px-4">
            {aboutData[index].info.map((item, itemIndex)=> {
              return(
                <div key={itemIndex} className=" flex-1 flex flex-col xl:flex-row max-w-max gap-x-2 items-center text-white">
