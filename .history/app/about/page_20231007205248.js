...
export default function Page() {
  ...
  return (
    <div className="h-full bg-primary/30 py-32 text-center xl:text-left">
      ...
      <div className="container mx-auto h-full flex flex-col items-center justify-center xl:flex-row gap-x-6 px-4 xl:px-24">
        <div className="flex-1 flex flex-col justify-start items-center xl:w-[650px]">
