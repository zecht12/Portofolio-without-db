    ...
    <div className="h-full bg-primary/30 py-32 text-center xl:text-left">
      ...
      <div className="container mx-auto h-full flex flex-col items-center xl:flex-row gap-x-6">
        <div className="flex-1 flex flex-col justify-center">
          ...
          <p>a year ago, i makes my first web at html and then i began to know react from dev news and then i know that react has framework that names next js. And then i deep dive learn about next js and database like mongodb firebase. Then 3</p>
        </div>
