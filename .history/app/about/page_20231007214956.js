    ...
    <div className="h-full bg-primary/30 py-36 text-center xl:text-left">
      ...
      <div className="container mx-auto h-full flex flex-col xl:flex-row gap-x-6 px-4 xl:px-24">
        <div className="flex-1 flex flex-col justify-start xl:w-[650px]">
          ...
          <div>
            <div className="relative flex-1 after:w-[1px] after:h-full after:bg-white/10 after:absolute after:yop-0 after:right-0 ">
              <div className="text-2xl xl:text-4xl font-extrabold text-accent text-center mb-0">
                <CountUp start={0} end={1} duration={5} />
              </div>
              <div className="text-xs uppercase tracking-[1px] max-w-[100px] leading-[1.4] px-2 ">
                Year Experience
              </div>
            </div>
          </div>
