  ...
  return (
    <div className="pt-32 md:pt-20">
      ...
      <div className="container mx-auto h-full flex flex-col items-center xl:flex-row gap-x-6">
        ...
        <div className="flex gap-x-4 cl:">
          {aboutData.map((item, itemIndex) =>{
            return(
              <div key={itemIndex} className="cursor-pointer capitalize xl:text-lg relative after:w-8 after:h-[2px] after:bg-white after:absolute after:bottom-1 after:left-0 " >
                {item.title}
              </div>
            )
          })}
