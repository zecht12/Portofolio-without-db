...
import {SiNextdotjs, SiVercel,SiFramer, SiTailwindcss, SiFirebase} from "react-icons/si";
      ...
      <div className="container mx-auto h-full flex flex-col items-center xl:flex-row gap-x-6">
        ...
        <div>
          {aboutData.map((item, itemIndex) =>{
            return(
              <div key={itemIndex} className="cursor-pointer capitalize xl:text-lg relative after:w-8 after:h-[2px] after:bg-white after:absolute " >
                {item.title}
              </div>
            )
          })}
