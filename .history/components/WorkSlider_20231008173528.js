                ...
                return(
                  <div key={index} className="relative overflow-hidden rounded-lg flex items-center justify-center group">
                    <div className="flex items-center justify-center relative overflow-hidden">
                      ...
                      <div className="bg-gradient-to-l absolute inset-0 from-transparent via-[#7a1b6b] to-[#210f55] opacity-0 group-hover:opacity-80 transition-all duration-700 "></div>
