      ...
      {testimonialData.map((person, index) => {
        return (
          <SwiperSlide key={index}>
            <div className="flex flex-col md:flex-row items-center gap-x-8 py-16 h-full">
              <div className="max-w-[300px] w-full flex flex-col xl:justify-center items-center relative mx-auto xl:mx-0">
                <div className="flex-col flex justify-center text-center">
                  <div className="mb-2 mx-auto">
                    <Image src={person.image} width={100} height={100} alt='images' />
                  </div>
                  <div className="text-lg">
                    {person.name}
                  </div>
                  <div className="text-[12px] font-extralight tracking-widest uppercase">
                    {person.position}
                  </div>
                </div>
              </div>
